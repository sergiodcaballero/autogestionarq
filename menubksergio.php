<ul class="nav nav-list bs-docs-sidenav">
    ...
    <li><a href="certificado_libre_deuda.php" class="orden">
            <i class="icon-chevron-right"></i>Matr&iacute;cula / Libre Deuda
        </a></li>
    <li class="nav-head">
        <a style=" color:#999;">
            <strong>EJERICIO PROFESIONAL</strong>
        </a>
    </li>
    <li><a href="calculo_tasas.php" class="orden">
            <i class="icon-chevron-right"></i>C&aacute;lculo de Tasas
        </a></li>
    <li><a href="http://www.arquitectosmisiones.org.ar/calculo/calculo.php" class="orden">
            <i class="icon-chevron-right"></i>C&aacute;lculo de Honorarios
        </a></li>
    <li class="nav-head"><a style=" color:#999;"><strong>MIS DATOS</strong></a> </li>
    <li><a href="http://www.arquitectosmisiones.org.ar/autogestion/home.php?p=formulario&id=2" class="orden"><i class="icon-chevron-right"></i>Cargar Título</a></li>
