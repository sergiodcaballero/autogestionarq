<ul class="nav nav-list bs-docs-sidenav">
    ...
    <?php } ?>
    <li class="nav-head"><a style=" color:#999;"><strong>EJERCICIO PROFESIONAL</strong></a> </li>
    <li><a href="calculo_tasas.php" class="orden">
            <i class="icon-chevron-right"></i>C&aacute;lculo de Tasas
        </a></li>
    <li>
        <a href="http://www.arquitectosmisiones.org.ar/calculo/calculoN.php" class="orden">
            <i class="icon-chevron-right"></i>Simulador de C&aacute;lculo de Honorarios
        </a>
    </li>
    <li>
        <a href="https://www.arquitectosmisiones.org.ar/?page_id=12222" class="orden">
            <i class="icon-chevron-right"></i>Honorarios M&iacute;nimos Referenciales
        </a>
    </li>
