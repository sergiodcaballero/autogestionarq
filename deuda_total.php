                	...
                	<div class="row">
                    	<div class="span4">
                        	<ul class="nav nav-list bs-docs-sidenav">
                                ...
                                <li class="active"><a href="deuda_total.php" class="orden"><i class="icon-chevron-right"></i>Total</a></li>
                        ...
                        <div class="span8">
								  ...
								  <table class="table table-striped table-condensed table-bordered table-responsive">
                                  	<tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo utf8_encode($fila['n_documento']);?></td>
                                        </tr>
                                        <tr>
							...
							<?php } ?>
								...
								<center><h3> Estado de Deuda Total </h3></center>
                                <p></p>
                                ...
                                <?php
									...
									if ($Cantidad_Filas==0){
										...
										while ($fila = mysqli_fetch_array($resultado)){
											echo "Su deuda Actual es de $<strong>".$fila['total']."</strong>";
										}
									}
                                ?><br /><p> <strong>A  los montos consignados al momento del pago se  calcularan las actualizaciones  por mora.</strong></p>
							<?php }
							?>
